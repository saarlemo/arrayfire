...
void launchMetalMeanshift(void* output, size_t outputBytes,
                          const af::dim4& dims, const af::dim4& outputStrides,
                          const void* input, size_t inputBytes,
                          const af::dim4& inputStrides, float spatialSigma,
                          float chromaticSigma, unsigned iterations, bool color,
                          af_dtype type);
