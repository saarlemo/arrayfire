...
void launchMetalRegions(void* output, size_t outputBytes, const af::dim4& dims,
                        const af::dim4& outputStrides, const void* input,
                        size_t inputBytes, const af::dim4& inputStrides,
                        af_connectivity connectivity);

inline void regionsMetal(Param<float> output, CParam<char> input,
    ...
    launchMetalRegions(
        ...
        output.dims(), output.strides(), input.get(), inputElements,
