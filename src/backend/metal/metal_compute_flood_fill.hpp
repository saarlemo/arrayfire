...
bool supportsMetalFloodFill(af_dtype type) noexcept;

void launchMetalFloodFill(void* output, size_t outputBytes,
                          const af::dim4& imageDims,
                          const af::dim4& imageStrides, const void* image,
                          size_t imageBytes, const void* seedX,
                          size_t seedXBytes, const af::dim4& seedDims,
                          const af::dim4& seedXStrides, const void* seedY,
